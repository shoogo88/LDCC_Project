...
<script>
	$(document).ready(function() {
		...
		$("#modifyBtn").click(function() {
			...
			// 상품 정보 전송
			document.ProductVO.action = "/modify";
			document.ProductVO.submit();
		});
		// 상품 목록이동
		$("#deleteBtn").click(function() {
			document.ProductVO.action = "/delete";
			document.ProductVO.submit();
		});
	...
	<!-- <form id="ProductVO" name="ProductVO" enctype="multipart/form-data" method="post">
	 ...
	 <form id="ProductVO" name="ProductVO"   method="post" >
		<table border="1">
			<tr>
				<td>상품명</td>
				<td><input type="text" name="pName" id="pName" value="${oneProduct.pName}"></td>
			</tr>
			<tr>
				<td>가격</td>
				<td><input type="text" name="pPrice" id="pPrice" value="${oneProduct.pPrice}"></td>
			</tr>
			<tr>
				<td>상품설명</td>
				<td><textarea rows="5" cols="60" name="pExplain" id="pExplain" >${oneProduct.pExplain}</textarea></td>
			</tr>
			<tr>
				<td>상품이미지</td>
				     
            <td>
<!--             <input type="file" name="productPhoto" id="productPhoto"></td>
 -->            <input type="text" name="pImagePath" id="pImagePath"></td>
